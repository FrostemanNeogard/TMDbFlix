export default function MainNavigation(props) {
  ...
  return (
    <div className="main-navigation">
      <h2>Movies</h2>
      <nav>
        <a href="/compileit-test-case/">
          <button id="home-button" className={activeButton == 'compileit-test-case/' ? 'active' : 'inactive'}>
            <span>
        ...
        <a href="/compileit-test-case/discover">
          <button id="discover-button" className={activeButton == 'compileit-test-case/discover' ? 'active' : 'inactive'}>
            <span>
